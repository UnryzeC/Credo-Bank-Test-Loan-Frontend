...
Ext.define('MyApp.view.main.MainController',
    {
        ...
        onSaveEditLoan: function( )
        {
            ...
            formData.type = isNaN( Number( formData.type ) ) ? MyApp.enum.Enums.getValueByName( MyApp.enum.Enums.loanType, formData.type ) : Number( formData.type );
            formData.currency = isNaN( Number( formData.currency ) ) ? MyApp.enum.Enums.getValueByName( MyApp.enum.Enums.currencyCode, formData.currency ) : Number( formData.currency );
            ...
            Ext.Ajax.request(
                {
                    ...
                    {
                        Ext.Msg.alert('Success', 'Loan request submitted successfully!', function( ) { location.reload( ); } );
                    },
